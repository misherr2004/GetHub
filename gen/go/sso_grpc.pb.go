...
type AuthClient interface {
	Register(ctx context.Context, in *RegistrRequest, opts ...grpc.CallOption) (*RegistrResponse, error)
...
func (c *authClient) Register(ctx context.Context, in *RegistrRequest, opts ...grpc.CallOption) (*RegistrResponse, error) {
...
type AuthServer interface {
	Register(context.Context, *RegistrRequest) (*RegistrResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *RegistrRequest) (*RegistrResponse, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*RegistrRequest))
	}
